...
# X_train = X_train_loaded.reshape(X_train_loaded.shape[0], 32, 32, 1)
# X_test = X_test_loaded.reshape(X_test_loaded.shape[0], 32, 32, 1)

# X_train = X_train_loaded.astype('float64')
# X_test = X_test_loaded.astype('float64')
...
class Network:
    def __init__(self):
        ...
        """
        model.add(Convolution2D(24, kernel_size=(3, 3), strides=(1, 1), activation='relu', input_shape=(32,32,1)))
    ...
    def train(self):
        ...
        self.model.fit(X_train, y_train, batch_size=32, epochs=2, verbose=1,
